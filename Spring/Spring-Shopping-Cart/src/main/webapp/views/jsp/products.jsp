...
<body>
					...
					<s:iterator value="productBean.cartProduct" status="stat">
						<s:iterator>
							<tr>
								...
								<td><s:property value="value.product_name" /></td>
								...
								<td><a
									href="/Spring-Shopping-Cart/deleteproduct?line_id=<s:property value="key.lineitem_id" />">Delete
								</a></td>
								<td><a href="#"
	...
	<script>
  	function updateproduct(e, index, lid){
  		...
  		var url = "http://localhost:8080/Spring-Shopping-Cart/updateproducts";
  		console.log(url);
